...
from sklearn.tree import DecisionTreeClassifier # Specific model for this file (DecisionTreeClassifier)
...
# --- Specific Tool Functions for Decision Tree Classification ---
...
def build_decision_tree_pipeline(ml_state: MLWorkflowState,
    ...
    """
    Tool to build a scikit-learn preprocessing and Decision Tree Classifier model pipeline.
    ...
    # Decision Trees are not sensitive to feature scaling, so 'none' is often suitable.
    ...
    # Instantiate the Decision Tree Classifier model with specified parameters
    ...
    print(f"Pipeline with Decision Tree Classifier built and stored with key: {ml_state.pipeline_key}")
    print(f"Model Parameters: {model_params}")


# --- Orchestrator Tool: run_decision_tree_workflow ---
def run_decision_tree_classification_workflow(
    path: str,
    target_column: str,
    ...
    dt_criterion: str = "gini", # Common criteria for classification: 'gini' or 'entropy'
    ...
    """
    A comprehensive tool to orchestrate an end-to-end Decision Tree Classifier workflow.
    """
    ...
    print(f"Starting Decision Tree Classification workflow for {path} with target '{target_column}'...")
    ...
    try:
        ...
        train_model(ml_state, apply_log_transform=False) # No log transform for DT classification target
